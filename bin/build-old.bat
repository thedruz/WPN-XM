...
SET INNOCOMPILER="%~dp0\bin\InnoSetup5\ISCC.exe"

echo  - compiling ... & echo. 

%INNOCOMPILER% "%~dp0innosetup\wpn-xm.iss" "/dtmpPath=%~dp0tmp\" "/dCVersion=%ServerpackVersion%" "/dbinPath=%~dp0bin" "/dXVersion=%Nginx-Version%" "/o%~dp0bin"
