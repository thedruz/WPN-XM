...
const
  ...
  //URL_phpext_memcache       = 'http://wpn-xm.org/get.php?s=phpext_memcache&p=7.2&bitsize=x64';
  ...
  //URL_phpext_rar            = 'http://wpn-xm.org/get.php?s=phpext_rar&p=7.2&bitsize=x64';
  ...
  URL_phpext_varnish        = 'http://wpn-xm.org/get.php?s=phpext_varnish&p=7.2&bitsize=x64';
