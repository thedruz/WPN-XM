...
OutputBaseFilename=WPNXM-{#AppVersion}-{#InstallerType}-Debug-Setup-php54-w32
...
const
  ...
  URL_vcredist              = 'http://wpn-xm.org/get.php?s=vcredist&v=9.0.30729.17'; // VCRedist 2008 x86
