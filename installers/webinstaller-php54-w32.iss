...
OutputBaseFilename=WPNXM-{#AppVersion}-{#InstallerType}-Setup-php54-w32
...
Name: asset-tools; Description: Google Closure Compiler; ExtraDiskSpaceRequired: 1000000; Types: full
...
const
  ...
  URL_phpext_jsond          = 'http://wpn-xm.org/get.php?s=phpext_jsond&p=5.4';
