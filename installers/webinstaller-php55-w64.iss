...
const
  ...
  // phpext_ice not available
  URL_phpext_imagick        = 'http://wpn-xm.org/get.php?s=phpext_imagick&p=5.5&bitsize=x64';
  URL_phpext_ioncube        = 'http://wpn-xm.org/get.php?s=phpext_ioncube&p=5.5&bitsize=x64';
  ...
  URL_phpext_mongodb        = 'http://wpn-xm.org/get.php?s=phpext_mongodb&p=5.5&bitsize=x64';
  ...
  URL_phpext_stats          = 'http://wpn-xm.org/get.php?s=phpext_stats&p=5.5&bitsize=x64';
