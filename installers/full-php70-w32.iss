...
Filename: "{tmp}\vcredist_x86_2015.exe"; Parameters: "/quiet /norestart"; Check: VCRedistx862015NeedsInstall; Flags: nowait
...
const
  ...
  // PHP Extension Ice is not available for PHP7 x86
...
begin
  ...
  begin
   ...
   // UpdateTotalProgressBar();
    ...
    {
      PHP Extensions ICE is not available for PHP7 x86.
    }
    {
