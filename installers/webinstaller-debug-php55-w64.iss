...
OutputBaseFilename=WPNXM-{#AppVersion}-{#InstallerType}-Debug-Setup-php55-w64
...
const
  ...
  URL_phpext_xcache     = 'http://wpn-xm.org/get.php?s=phpext_xcache&p=5.5';
  URL_phpext_xdebug     = 'http://wpn-xm.org/get.php?s=phpext_xdebug&p=5.5';
  URL_phpext_xhprof     = 'http://wpn-xm.org/get.php?s=phpext_xhprof&p=5.5';
