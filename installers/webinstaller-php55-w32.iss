...
OutputBaseFilename=WPNXM-{#APP_VERSION}-{#INSTALLER_TYPE}-Setup-php55-w32
...
const
  ...
  URL_phpext_mongo          = 'http://wpn-xm.org/get.php?s=phpext_mongo&p=5.5';
  ...
  URL_phpext_wincache       = 'http://wpn-xm.org/get.php?s=phpext_wincache&p=5.5';
  URL_phpext_xdebug         = 'http://wpn-xm.org/get.php?s=phpext_xdebug&p=5.5';
  URL_phpext_uprofiler      = 'http://wpn-xm.org/get.php?s=phpext_uprofiler&p=5.5';
  URL_phpext_zmq            = 'http://wpn-xm.org/get.php?s=phpext_zmq&p=5.5';
...
begin
  ...
  UpdateCurrentComponentName('Nginx');
    DoUnzip(targetPath + Filename_nginx, appDir + '\bin'); // no subfolder, brings own dir
  ...
  begin
    UpdateCurrentComponentName('Go Git Service');
      DoUnzip(ExpandConstant(targetPath + Filename_gogitservice), appDir + '\bin'); // no subfolder, brings own dir (/gogs)
