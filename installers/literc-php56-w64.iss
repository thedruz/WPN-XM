...
Source: ..\downloads\literc-{#APP_VERSION}-php5.6-w64\*; DestDir: {tmp}; Flags: nocompression deleteafterinstall;
// tools:
...
// Visual C++ Redistributable 2010 is needed by PHP VC11 x64 builds
