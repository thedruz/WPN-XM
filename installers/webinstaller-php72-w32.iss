...
const
  ...
  URL_php                   = 'http://wpn-xm.org/get.php?s=php&p=7.2';
  URL_phpcsfixer            = 'http://wpn-xm.org/get.php?s=php-cs-fixer';
  URL_phpext_amqp           = 'http://wpn-xm.org/get.php?s=phpext_amqp&p=7.2'; // no build
  URL_phpext_apcu           = 'http://wpn-xm.org/get.php?s=phpext_apcu&p=7.2';
  //URL_phpext_ice            = 'http://wpn-xm.org/get.php?s=phpext_ice&p=7.2';  // phpext_ice not available for PHP 7.1 x64
  URL_phpext_imagick        = 'http://wpn-xm.org/get.php?s=phpext_imagick&p=7.2';
  // NOTE: phpext_jsond is part of PHP 7, because of Douglas Crockford
  URL_phpext_mailparse      = 'http://wpn-xm.org/get.php?s=phpext_mailparse&p=7.2';
  //URL_phpext_memcache       = 'http://wpn-xm.org/get.php?s=phpext_memcache&p=7.2';
  URL_phpext_mongodb        = 'http://wpn-xm.org/get.php?s=phpext_mongodb&p=7.2';
  URL_phpext_msgpack        = 'http://wpn-xm.org/get.php?s=phpext_msgpack&p=7.2';
  URL_phpext_pdo_sqlsrv     = 'http://wpn-xm.org/get.php?s=phpext_pdo_sqlsrv&p=7.2';
  //URL_phpext_phalcon        = 'http://wpn-xm.org/get.php?s=phpext_phalcon&p=7.2';
  //URL_phpext_rar            = 'http://wpn-xm.org/get.php?s=phpext_rar&p=7.2';
  // runkit
  //URL_phpext_stats          = 'http://wpn-xm.org/get.php?s=phpext_stats&p=7.2';
  URL_phpext_sqlsrv         = 'http://wpn-xm.org/get.php?s=phpext_sqlsrv&p=7.2';
  URL_phpext_trader         = 'http://wpn-xm.org/get.php?s=phpext_trader&p=7.2';
  // uploadprogress not AV for 7
  URL_phpext_varnish        = 'http://wpn-xm.org/get.php?s=phpext_varnish&p=7.2';
  URL_phpext_xdebug         = 'http://wpn-xm.org/get.php?s=phpext_xdebug&p=7.2';
  URL_phpext_zmq            = 'http://wpn-xm.org/get.php?s=phpext_zmq&p=7.2';
  ...
  URL_rclone                = 'http://wpn-xm.org/get.php?s=rclone-x86';
  ...
  URL_vcredist              = 'http://wpn-xm.org/get.php?s=vcredist&v=14.0.23026'; // Visual C++ Redistributable for Visual Studio 2015
...
begin
  ...
  if (VCRedist_x86_2015_NeedsInstall() = TRUE) then
  begin
